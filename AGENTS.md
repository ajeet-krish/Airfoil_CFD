...
- `docs/airfoils/naca0012.html` — Airfoil-specific results: summary table, aggregate plots, per-AoA metric cards + visualizations
- `docs/implementation.html` — How to run, code architecture, SU2 config reference, 6 expandable source blocks
- `docs/paraview.html` — ParaView walkthrough with 11+ visualization recipes (temporary)
...
4. **Missing KaTeX scripts**: methodology.html had CSS but missing JS — fixed
