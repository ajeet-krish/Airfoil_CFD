...
- All pages share `nav.top-nav` bar: **Home | Methodology | Airfoil Analysis | Optimization | Structural Analysis | Implementation | ParaView**
...
- VTU exported to `output_optimized/fea/results.vtu` for ParaView
...
10. **Navigation updated**: All 7 pages now have **Home | Methodology | Airfoil Analysis |
    Optimization | Structural Analysis | Implementation | ParaView** nav bar.
